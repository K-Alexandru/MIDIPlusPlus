...
its order. Hotkeys and custom themes are built (`9d0f64f`), neither fully pressed; Legit mode is next.
...
- **Themes: the picker is now the app's own and has never been dragged.** Drag it, use the
...
- **Tester shampoojr** to confirm that list on the `9d0f64f` build; none of it
